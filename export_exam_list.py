...
Если пароль не найден - в поле пароля добавляется "не зарегистрирован", если
абитуриента случайно зарегистрировали повторно - "несколько учётных записей"
...
Параметры командной строки:
  ...
  Необязательные
   второй: каталог с файлами всех зарегистрированных (csv с разеделителем "," и текстовыми полми в кавычках)
           работает относительный каталог, чтобы много не писать
  все файлы должны быть в кодировк utf-8 без BOM (который требует для работы MS Excel)
"""
